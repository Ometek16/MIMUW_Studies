...
public class TestAssign {
    ...
    public static Stream<Expression> getTestDataAssign() {
        return Stream.of(
                Constant.of(5),
    ...
    @ParameterizedTest
    @MethodSource("getTestDataAssign")
    public void shouldAssign(Expression expression) throws Exception {
        Block block = new Block().declare('x', Constant.of(0)).assign('x', expression).print(Variable.named('x')).endBlock();
